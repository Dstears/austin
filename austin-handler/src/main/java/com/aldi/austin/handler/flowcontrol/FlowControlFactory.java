package com.aldi.austin.handler.flowcontrol;
...
public class FlowControlFactory implements ApplicationContextAware {
    ...
    @Value(("${austin.flow-control-config:{}}"))
    private String flowControlConfig;
     ...
     * <p>
     * 渠道枚举可看：com.aldi.austin.common.enums.ChannelType
     *
     * @param channelCode
     */
